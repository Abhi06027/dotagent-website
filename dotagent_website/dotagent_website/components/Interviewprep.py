        ...
        xt.box(
            ...
            xt.box(
                xt.box(
                    xt.image(
                        src="/you-image.jpg",
                        class_name="lg:w-80 lg:h-80 md:w-80 w-72 relative text-lg font-DMSans rounded-t-lg font-semibold text-[#6c7275] bg-[rgba(20,_23,_24,_0.5)] self-start",
                    ),
                    xt.box(
                        xt.box(
                            xt.image(
                            ...
                            xt.box(
                                xt.box(
                                    xt.text(
                                        "Duolingo",
                                        class_name="md:text-sm text-xs font-DMSans font-medium text-[#fefefe] leading-6",
                                    ),
                                    xt.text(
                                        "Language learning app",
                                        class_name="text-[0.65rem] md:text-xs font-DMSans font-medium leading-4 text-[#6c7275]",
                                    ),
                                ...
                                xt.box(
                                    xt.box(
                                        ...
                                        xt.text(
                                            "$20",
                                            class_name="text-xs line-through font-DMSans tracking-[0.36] text-[#ee806f]",
                                        ),
                                    ),
                ...
                xt.box(
                    ...
                    xt.box(
                        xt.box(
                            ...
                            class_name="bg-[#1b1e1f] flex lg:w-full md:w-80 w-72 gap-4 p-4 rounded-b-lg",
                        ),
                    ),
                ),
